...
class __TwigTemplate_f1a9f29aa75db9b3eabe0a956a5d1a23a6414fb08352f1495048674ebdc59037 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"example-wrapper\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["calendriers"]) || array_key_exists("calendriers", $context) ? $context["calendriers"] : (function () { throw new RuntimeError('Variable "calendriers" does not exist.', 34, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["calendrier"]) {
            // line 35
            echo "                        <tr>
                            <td>";
            // line 36
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["calendrier"], "getId", [], "method", false, false, false, 36), "html", null, true);
            echo "</td>
                            <td>";
            // line 37
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["calendrier"], "getEditionCalendrier", [], "method", false, false, false, 37), "html", null, true);
            echo "</td>
                        </tr>
                    ";
        }
...
";
    ...
    {
        return array (  139 => 40,  130 => 37,  126 => 36,  123 => 35,  119 => 34,  106 => 23,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "calendrier/index.html.twig", "/home/sow/symfony/TP-Athletisme-crud-symfony/templates/calendrier/index.html.twig");
    }
}
